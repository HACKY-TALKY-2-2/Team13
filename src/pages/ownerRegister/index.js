...
const OwnerRegister = () => {
    ...
    const handleShopNameChange = (e) => {
        ...
        setTriggerSearch(true); // 준호 추가 코드
    };

    //준호 추가 코드
    const handleAddressChange = (e) => {
        setAddress(e.target.value);
        setTriggerSearch(true); // Set this to true to trigger search
    };
                ...
                <RegisterFlex>
                    {page === 0 ? (
                        <>
                            ...
                            <FieldWrapper>
                                ...
                                <InputsWrapper>
                                    ...
                                    ></SmallInput>
                                    <FixedText style={{ 'font-size': '30px' }}>
                                        @
                                    </FixedText>
                                    <CustomSelect
                                        size="lg"
                        ...
                        <>
                            ...
                            <FieldWrapper>
                                <Title>테이블</Title>
                                {[...Array(numTableGroups).keys()].map(
                                    (index) => (
                                        <InputsWrapper key={index}>
                                            <SmallInput
                                                type="text"
                                                onChange={(e) =>
                                                    handleSeatsPerTableChange(
                                                        index,
                                                        e.target.value
                                                    )
                                                }
