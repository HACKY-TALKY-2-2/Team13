package com.around.table.config;
...
public class SwaggerConfig implements WebMvcConfigurer {
    ...
    */
    ...
    private static final String SERVICE_NAME = "HACKY-TALKY Project";
    private static final String API_VERSION = "V3";
    private static final String API_DESCRIPTION = "HACKY-TALKY API 명세서";
    ...
    private ApiInfo apiInfo() {
        return new ApiInfoBuilder().title(SERVICE_NAME) // 서비스명
                ...
                .licenseUrl("https://localhost:8080")
                .build();
